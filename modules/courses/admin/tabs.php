...
$table_name =  NV_PREFIXLANG . '_' . $module_data . '_tabs';
...
$_sql = 'SELECT * FROM ' . NV_PREFIXLANG . '_' . $module_data . '_template';
...
$array_select_content['content_listcourse'] = $lang_module['tabs_content_listcourse'];
